...
import main.RunnerGamePanel.JumpActionListener;
import main.RunnerGamePanel.JumpKeyListener;
import main.RunnerGamePanel.JumpMouseListener;
...
public class RunnerGamePanel extends JPanel{
	...
	// constants
				...
				// properties
				private SwingContainer obstacles;
				...
				private void init() {
					...
					heightOfJump = 0;
					flag = false;
					jumpTimer = new Timer( 3,  (ActionListener) new JumpActionListener());
					border = new Rectangle( 35, 60);
					border.setLocation(50, BASEY - 80 - heightOfJump);
					
					isGameOver = false;
					
					obstacles = (SwingContainer) new ShapeContainer();
					obstacles.add( new Obstacle( 780, BASEY - 20));
					
					runnerGif = new ArrayList<Image>();
					for ( int i = 0; i < 9; i ++)
						runnerGif.add(( new ImageIcon( this.getClass().getResource( "/tmp-" + i + ".gif")).getImage()));
				...
				class TimerActionListener implements ActionListener {
					public void actionPerformed( ActionEvent e) {
						...
						Obstacle obstacle = ( (Obstacle) obstacles.getShape( ((Component) obstacles).size() - 1) );
